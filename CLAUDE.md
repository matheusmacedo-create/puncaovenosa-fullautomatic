...
- `SIMULAR_PAGAMENTO` é variável de **servidor**, lida a cada requisição e devolvida ao cliente dentro da resposta da cobrança. Não use `NEXT_PUBLIC_*` para isso: seria embutida no build e mudá-la no painel exigiria novo deploy.
